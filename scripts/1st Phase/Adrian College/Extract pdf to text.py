...
if __name__ == "__main__":
    input_pdf_file = "./adrian-college.pdf"  # Replace with your input PDF file path
    output_text_file = "adrian-college.txt"  # Replace with the desired output text file path
    start_page_number = 190 # Replace with the starting page number
    end_page_number = 277  # Replace with the ending page number
