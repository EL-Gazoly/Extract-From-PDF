...
if __name__ == "__main__":
    input_pdf_file = "./AlabamaAGriculturalMechanicalUniversity.pdf"  # Replace with your input PDF file path
    output_text_file = "AlabamaAGriculturalMechanicalUniversity.txt"  # Replace with the desired output text file path
    start_page_number = 217 # Replace with the starting page number
    end_page_number = 362  # Replace with the ending page number
