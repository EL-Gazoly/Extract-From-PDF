...
if __name__ == "__main__":
    input_pdf_file = "./bacone-college.pdf"  # Replace with your input PDF file path
    output_text_file = "./bacone-college.txt"  # Replace with the desired output text file path
    start_page_number = 112 # Replace with the starting page number
    end_page_number = 190  # Replace with the ending page number
