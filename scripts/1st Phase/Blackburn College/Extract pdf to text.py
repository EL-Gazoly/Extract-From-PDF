...
if __name__ == "__main__":
    input_pdf_file = "./blackburn-college.pdf"  # Replace with your input PDF file path
    output_text_file = "blackburn-college.txt"  # Replace with the desired output text file path
    start_page_number = 71 # Replace with the starting page number
