...
if __name__ == "__main__":
    input_pdf_file = "./cincinnati-christian-university.pdf"  # Replace with your input PDF file path
    output_text_file = "cincinnati-christian-university.txt"  # Replace with the desired output text file path
    start_page_number = 128 # Replace with the starting page number
    end_page_number = 212  # Replace with the ending page number
