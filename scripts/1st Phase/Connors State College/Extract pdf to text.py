...
if __name__ == "__main__":
    input_pdf_file = "./connors-state-college.pdf"  # Replace with your input PDF file path
    output_text_file = "connors-state-college.txt"  # Replace with the desired output text file path
    start_page_number = 112 # Replace with the starting page number
    end_page_number = 132  # Replace with the ending page number
