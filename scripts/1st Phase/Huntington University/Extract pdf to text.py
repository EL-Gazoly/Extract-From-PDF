...
if __name__ == "__main__":
    input_pdf_file = "./huntington-university.pdf"  # Replace with your input PDF file path
    output_text_file = "output.txt"  # Replace with the desired output text file path
    start_page_number = 289 # Replace with the starting page number
    end_page_number = 294  # Replace with the ending page number
