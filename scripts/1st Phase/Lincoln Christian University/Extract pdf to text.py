...
if __name__ == "__main__":
    input_pdf_file = "./lincoln-christian-university.pdf"  # Replace with your input PDF file path
    output_text_file = "lincoln-christian-university.txt"  # Replace with the desired output text file path
    start_page_number = 21 # Replace with the starting page number
    end_page_number = 55  # Replace with the ending page number
