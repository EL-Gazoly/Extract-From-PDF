...
if __name__ == "__main__":
    input_pdf_file = "./mount-vernon-nazarene-college.pdf"  # Replace with your input PDF file path
    output_text_file = "mount-vernon-nazarene-college.txt"  # Replace with the desired output text file path
    start_page_number = 152 # Replace with the starting page number
    end_page_number = 215  # Replace with the ending page number
