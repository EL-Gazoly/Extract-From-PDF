...
if __name__ == "__main__":
    input_pdf_file = "./murray-state-college.pdf"  # Replace with your input PDF file path
    output_text_file = "murray-state-college.txt"  # Replace with the desired output text file path
    start_page_number = 65 # Replace with the starting page number
    end_page_number = 103  # Replace with the ending page number
