...
if __name__ == "__main__":
    input_pdf_file = "./oakland-city-university.pdf"  # Replace with your input PDF file path
    output_text_file = "oakland-city-university.txt"  # Replace with the desired output text file path
    start_page_number = 165 # Replace with the starting page number
    end_page_number = 227  # Replace with the ending page number
