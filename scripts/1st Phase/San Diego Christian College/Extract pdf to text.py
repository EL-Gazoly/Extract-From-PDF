...
if __name__ == "__main__":
    input_pdf_file = "./san-diego-christian-college.pdf"  # Replace with your input PDF file path
    output_text_file = "san-diego-christian-college.txt"  # Replace with the desired output text file path
    start_page_number = 128 # Replace with the starting page number
    end_page_number = 196  # Replace with the ending page number
