...
if __name__ == "__main__":
    input_pdf_file = "./thomas-more-university.pdf"  # Replace with your input PDF file path
    output_text_file = "thomas-more-university.txt"  # Replace with the desired output text file path
    start_page_number = 102 # Replace with the starting page number
    end_page_number = 213  # Replace with the ending page number
