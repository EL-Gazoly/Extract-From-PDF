...
if __name__ == "__main__":
    input_pdf_file = "E:/Projects/Extract-From-PDF/scripts/2nd Phase/Angelina College/angelina-college.pdf"  # Replace with your input PDF file path
    output_text_file = "angelina-college.txt"  # Replace with the desired output text file path
    start_page_number = 218 # Replace with the starting page number
    end_page_number = 302  # Replace with the ending page number
