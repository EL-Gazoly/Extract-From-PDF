...
if __name__ == "__main__":
    input_pdf_file = "./cameron-university.pdf"  # Replace with your input PDF file path
    output_text_file = "cameron-university.txt"  # Replace with the desired output text file path
    start_page_number = 104 # Replace with the starting page number
    end_page_number = 176  # Replace with the ending page number
