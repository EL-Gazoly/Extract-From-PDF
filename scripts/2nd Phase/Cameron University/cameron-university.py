...
with open('cameron-university.csv', 'w', newline='', encoding='utf-8') as csv_file:
    ...
    # Write header row
    csv_writer.writerow(['code', 'title', 'credits', 'description', 'prerequisites', 'corequisite'])

    # Write course data rows
    for course in course_data:
        csv_writer.writerow([course['code'], course['title'], course['credits'], course['description'], course['prerequisites'], course['corequisite']])

print("CSV file 'cameron-university' has been created with the extracted course data.")
