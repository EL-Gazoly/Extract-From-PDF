...
if __name__ == "__main__":
    input_pdf_file = "./collin-college.pdf"  # Replace with your input PDF file path
    output_text_file = "collin-college.txt"  # Replace with the desired output text file path
    start_page_number = 207 # Replace with the starting page number
    end_page_number = 324  # Replace with the ending page number
