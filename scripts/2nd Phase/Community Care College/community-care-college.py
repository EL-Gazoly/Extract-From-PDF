...
# Open the text file
with open('community-care-college.txt', 'r', encoding='utf-8') as txt_file:
...
with open('community-care-college.csv', 'w', newline='', encoding='utf-8') as csv_file:
    ...
    # Write header row
    csv_writer.writerow(['code', 'title', 'credits', 'description', 'lecture_hrs', 'lab_hrs'])

    # Write course data rows
    for course in course_data:
        csv_writer.writerow([course['code'], course['title'], course['credits'], course['description'], course['lecture_hrs'], course['lab_hrs']])
