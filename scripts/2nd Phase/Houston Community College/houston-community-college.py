...
class HoustronCollegeScraper(scrapy.Spider):
    name = 'houston-community-college'

    def start_requests(self):
        url = 'https://catalog.hccs.edu/content.php?catoid=14&navoid=1077'
...
crawler = CrawlerProcess(settings={
    "FEEDS": {"houston-community-college.csv": {"encoding": "utf8", "format": "csv", "overwrite": True}},
    "LOG_LEVEL": logging.DEBUG
})
crawler.crawl(HoustronCollegeScraper)
