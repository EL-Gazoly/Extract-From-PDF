...
# Open the text file
with open('Northeastern Oklahoma Agricultural and Mechanical College.txt', 'r', encoding='utf-8') as txt_file:
...
with open('Northeastern Oklahoma Agricultural and Mechanical College.csv', 'w', newline='', encoding='utf-8') as csv_file:
    ...
    # Write header row
    csv_writer.writerow(['code', 'title', 'credits_range', 'description'])
