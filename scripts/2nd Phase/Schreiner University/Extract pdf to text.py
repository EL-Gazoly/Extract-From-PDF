...
if __name__ == "__main__":
    input_pdf_file = "./schreiner-university.pdf"  # Replace with your input PDF file path
    output_text_file = "./schreiner-university.txt"  # Replace with the desired output text file path
    start_page_number = 104 # Replace with the starting page number
    end_page_number = 251  # Replace with the ending page number
