...
if __name__ == "__main__":
    input_pdf_file = "./southeastern-oklahoma.pdf"  # Replace with your input PDF file path
    output_text_file = "./southeastern-oklahoma.txt"  # Replace with the desired output text file path
    start_page_number = 240 # Replace with the starting page number
    end_page_number = 325  # Replace with the ending page number
