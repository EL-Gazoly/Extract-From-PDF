...
if __name__ == "__main__":
    input_pdf_file = "./southwestern-oklahoma.pdf"  # Replace with your input PDF file path
    output_text_file = "./southwestern-oklahoma.txt"  # Replace with the desired output text file path
    start_page_number = 295 # Replace with the starting page number
    end_page_number = 361  # Replace with the ending page number
