...
if __name__ == "__main__":
    input_pdf_file = "./spartan-catalog.pdf"  # Replace with your input PDF file path
    output_text_file = "./spartan-catalog.txt"  # Replace with the desired output text file path
    start_page_number = 69 # Replace with the starting page number
    end_page_number = 84  # Replace with the ending page number
