...
if __name__ == "__main__":
    input_pdf_file = "./sul-ross-state-university.pdf"  # Replace with your input PDF file path
    output_text_file = "./sul-ross-state-university.txt"  # Replace with the desired output text file path
    start_page_number = 246 # Replace with the starting page number
    end_page_number = 459  # Replace with the ending page number
