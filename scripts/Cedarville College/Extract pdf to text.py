...
if __name__ == "__main__":
    input_pdf_file = "./cedarville-college.pdf"  # Replace with your input PDF file path
    output_text_file = "cedarville-college.txt"  # Replace with the desired output text file path
    start_page_number = 222 # Replace with the starting page number
    end_page_number = 307  # Replace with the ending page number
