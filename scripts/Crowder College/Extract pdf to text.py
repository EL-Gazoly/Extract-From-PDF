...
if __name__ == "__main__":
    input_pdf_file = "./crowder-college.pdf"  # Replace with your input PDF file path
    output_text_file = "./crowder-college.txt"  # Replace with the desired output text file path
    start_page_number = 31 # Replace with the starting page number
    end_page_number = 62  # Replace with the ending page number
