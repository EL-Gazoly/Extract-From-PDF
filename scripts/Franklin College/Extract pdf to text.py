...
if __name__ == "__main__":
    input_pdf_file = "./FranklinCollege.pdf"  # Replace with your input PDF file path
    output_text_file = "./FranklinCollege.txt"  # Replace with the desired output text file path
