...
if __name__ == "__main__":
    input_pdf_file = "./houghton-university.pdf"  # Replace with your input PDF file path
    output_text_file = "./houghton-university.txt"  # Replace with the desired output text file path
    start_page_number = 256 # Replace with the starting page number
    end_page_number = 375  # Replace with the ending page number
