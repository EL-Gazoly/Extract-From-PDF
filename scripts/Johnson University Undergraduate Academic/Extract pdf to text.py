...
if __name__ == "__main__":
    input_pdf_file = "./Johnson University Undergraduate Academic.pdf"  # Replace with your input PDF file path
    output_text_file = "./JohnsonUniversityUndergraduateAcademic.txt"  # Replace with the desired output text file path
    start_page_number = 317 # Replace with the starting page number
    end_page_number = 369  # Replace with the ending page number
