...
# Open the text file
with open('JohnsonUniversityUndergraduateAcademic.txt', 'r', encoding='utf-8') as txt_file:
...
with open('JohnsonUniversityUndergraduateAcademic.csv', 'w', newline='', encoding='utf-8') as csv_file:
