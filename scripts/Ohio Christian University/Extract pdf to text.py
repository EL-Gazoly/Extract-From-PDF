...
if __name__ == "__main__":
    input_pdf_file = "./ohio-christian-university.pdf"  # Replace with your input PDF file path
    output_text_file = "ohio-christian-university.txt"  # Replace with the desired output text file path
    start_page_number = 107 # Replace with the starting page number
    end_page_number = 155  # Replace with the ending page number
