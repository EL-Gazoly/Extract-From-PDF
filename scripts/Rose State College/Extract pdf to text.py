...
if __name__ == "__main__":
    input_pdf_file = "./rose-state-college.pdf"  # Replace with your input PDF file path
    output_text_file = "rose-state-college.txt"  # Replace with the desired output text file path
    start_page_number = 321 # Replace with the starting page number
    end_page_number = 377  # Replace with the ending page number
