...
if __name__ == "__main__":
    input_pdf_file = "./the-kings-college.pdf"  # Replace with your input PDF file path
    output_text_file = "the-kings-college.txt"  # Replace with the desired output text file path
    start_page_number = 150 # Replace with the starting page number
    end_page_number = 189  # Replace with the ending page number
