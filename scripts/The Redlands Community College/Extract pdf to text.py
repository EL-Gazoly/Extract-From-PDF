...
if __name__ == "__main__":
    input_pdf_file = "./the-redlands-community-college.pdf"  # Replace with your input PDF file path
    output_text_file = "the-redlands-community-college.txt"  # Replace with the desired output text file path
    start_page_number = 106 # Replace with the starting page number
    end_page_number = 131  # Replace with the ending page number
