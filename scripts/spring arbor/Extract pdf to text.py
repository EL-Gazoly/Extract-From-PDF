...
if __name__ == "__main__":
    input_pdf_file = "./spring-arbor.pdf"  # Replace with your input PDF file path
    output_text_file = "./spring-arbor.txt"  # Replace with the desired output text file path
    start_page_number = 223 # Replace with the starting page number
    end_page_number = 305  # Replace with the ending page number
